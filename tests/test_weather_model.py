...
from meal_max.weather_service import fetch_current_weather

def test_fetch_current_weather(mocker):
    user_id = 1

    # Mock get_favorite
    mock_get_favorite = mocker.patch("meal_max.weather_service.get_favorite")
    mock_get_favorite.return_value = ("Boston", 42.3601, -71.0589)

    # Mock requests.get
    mock_requests_get = mocker.patch("meal_max.weather_service.requests.get")
